...
#include "lidar_localization/models/sliding_window/factors/factor_prvag_prior_pose.hpp"
...
private:
    ...
    Eigen::Matrix3d GetInformationMatrix(Eigen::Vector3d noise);
    ...
    sliding_window::FactorPRVAGGNSSPose *GetResGNSSPose(const ResidualGNSSPose &res_gnss_pose);
    ...
    struct {
      ...
      std::deque<ResidualGNSSPose> gnss_pose;
    } residual_blocks_;


    bool use_map_matching;
    bool use_imu_pre_integration;
    bool use_gnss;
};
