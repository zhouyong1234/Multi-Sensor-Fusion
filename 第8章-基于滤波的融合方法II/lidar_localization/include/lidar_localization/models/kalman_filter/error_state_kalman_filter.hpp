...
private:
  ...
  // dimensions:
  static constexpr int kDimMeasurementPose{9};
  static const int kDimMeasurementPoseNoise{9};
   ...
   * @return void
   */
  void CorrectErrorEstimationPose(const Eigen::Matrix4d &T_nb, const Eigen::Vector3d &v_b,
                                  Eigen::Matrix<double, 9, 1> &Y, Eigen::Matrix<double, 9, 15> &G,
