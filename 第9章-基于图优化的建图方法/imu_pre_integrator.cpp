...
void IMUPreIntegrator::UpdateState(void) {
    ...
    F_.block<3,3>(INDEX_ALPHA, INDEX_THETA) = F_.block<3,3>(INDEX_BETA, INDEX_THETA) = -0.5 * (prev_R_a_hat + curr_R_a_hat * dR_inv);
    F_.block<3,3>(INDEX_ALPHA, INDEX_THETA) = 0.5 * T * F_.block<3,3>(INDEX_ALPHA, INDEX_THETA);

    F_.block<3,3>(INDEX_ALPHA, INDEX_B_A) = F_.block<3,3>(INDEX_BETA, INDEX_B_A) = -0.5 * (prev_R + curr_R);
    F_.block<3,3>(INDEX_ALPHA, INDEX_B_A) = 0.5 * T * F_.block<3,3>(INDEX_ALPHA,  INDEX_B_A);

    F_.block<3,3>(INDEX_ALPHA, INDEX_B_G) = F_.block<3,3>(INDEX_BETA, INDEX_B_G) = 0.5 * T * curr_R_a_hat;
    F_.block<3,3>(INDEX_ALPHA, INDEX_B_G) = 0.5 * T * F_.block<3,3>(INDEX_ALPHA, INDEX_B_G);
    ...
    B_.block<3,3>(INDEX_ALPHA, INDEX_M_ACC_PREV) = 0.5 * T * B_.block<3,3>(INDEX_ALPHA, INDEX_M_ACC_PREV);

    B_.block<3,3>(INDEX_ALPHA, INDEX_M_GYR_PREV) = B_.block<3,3>(INDEX_BETA, INDEX_M_GYR_PREV) = -0.25 * T * curr_R_a_hat;

    B_.block<3,3>(INDEX_ALPHA, INDEX_M_GYR_PREV) = 0.5 * T * B_.block<3,3>(INDEX_ALPHA, INDEX_M_GYR_PREV);

    B_.block<3,3>(INDEX_ALPHA, INDEX_M_ACC_CURR) = B_.block<3,3>(INDEX_BETA, INDEX_M_ACC_CURR) = 0.5 * curr_R;
    B_.block<3,3>(INDEX_ALPHA, INDEX_M_ACC_CURR) = 0.5 * T * B_.block<3,3>(INDEX_ALPHA, INDEX_M_ACC_CURR);

    B_.block<3,3>(INDEX_ALPHA, INDEX_M_GYR_CURR) = B_.block<3,3>(INDEX_BETA, INDEX_M_GYR_CURR) = -0.25 * T * curr_R_a_hat;
    B_.block<3,3>(INDEX_ALPHA, INDEX_M_GYR_CURR) = 0.5 * T * B_.block<3,3>(INDEX_ALPHA, INDEX_M_GYR_CURR);
